...
An simple add-on for Exporting and Importing skin weights from mesh to JSON using Position or UV mapping method. Compatible with blender 4.3.2 and lower
